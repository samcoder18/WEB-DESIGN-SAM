    ...
    <>
      <div className="flex flex-wrap items-start gap-4 md:flex-nowrap md:items-center md:gap-8">
        ...
        <div className="min-w-[150px] flex-1 pt-2 md:pt-0">
          ...
          <h3 id={titleId} className="site-card-title site-card-title--project site-card-title--dark mt-2">
            {project.name}
          </h3>
        </div>
...
function ProjectCard({
  ...
  return (
    <motion.article
      ...
      className="absolute left-0 right-0 flex min-h-[480px] flex-col overflow-hidden rounded-[40px] border-2 border-frost bg-ink p-4 text-frost shadow-[0_28px_80px_rgba(0,0,0,0.28)] sm:min-h-[560px] sm:rounded-[50px] sm:p-6 md:rounded-[60px] md:p-8"
      style={{
        top: parkedTop,
...
export function ProjectsSection() {
  ...
  return (
    <section
      id="проекты"
      className="relative z-10 rounded-t-[40px] bg-transparent px-5 py-20 sm:rounded-t-[50px] sm:px-8 sm:py-24 md:rounded-t-[60px] md:px-10 md:py-32"
    >
      <FadeIn y={40}>
        <h2 className="about-manifesto-heading mb-16 text-center sm:mb-20 md:mb-28">Работы</h2>
      </FadeIn>
        ...
        <div className="mx-auto max-w-7xl space-y-6">
          {projects.map((project, index) => (
            <article
              ...
              className="flex min-h-[480px] flex-col overflow-hidden rounded-[40px] border-2 border-frost bg-ink p-4 text-frost shadow-[0_28px_80px_rgba(0,0,0,0.28)] sm:min-h-[560px] sm:rounded-[50px] sm:p-6 md:rounded-[60px] md:p-8"
            >
