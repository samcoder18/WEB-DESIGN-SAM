...
export const services: Service[] = [
  {
    ...
    description:
      'Создаём выразительные лендинги с сильной визуальной идеей, продуманной драматургией экрана и акцентом на первое впечатление.',
  ...
  },
  {
    ...
    description:
      'Проектируем и разрабатываем сайты с продуманной структурой, адаптивной вёрсткой, анимациями, формами, CMS и интеграциями.',
  ...
  },
  {
    ...
    description:
      'Разрабатываем цельный образ бренда: логотип, палитру, типографику, графические элементы и правила их использования.',
