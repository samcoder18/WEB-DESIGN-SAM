...
export const services: Service[] = [
  {
    ...
    description:
      'Создание детализированных объектов, персонажей и окружений под конкретные задачи клиента — идеально для игр, продуктов и визуализаций.',
  },
  {
    number: '02',
    name: 'Рендеринг',
    description:
      'Качественные фотореалистичные рендеры, которые раскрывают дизайн через индивидуальный свет, текстуры и материалы, оживляя концепции.',
  },
  {
    number: '03',
    name: 'Моушн-дизайн',
    description:
      'Динамичная анимация и motion graphics, которые добавляют брендам, продуктам и цифровому опыту энергию и сторителлинг.',
  },
  {
    number: '04',
    name: 'Брендинг',
    description:
      'Создание целостной визуальной айдентики — от логотипов до полноценных бренд-систем, которые передают ясный и запоминающийся образ.',
  },
  {
    number: '05',
    name: 'Веб-дизайн',
    description:
      'Дизайн чистых, современных и ориентированных на конверсию сайтов с вниманием к сетке, типографике и пользовательскому опыту.',
  },
];
